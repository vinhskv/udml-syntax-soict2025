...
/*package*/ class Association_AsDiagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Association_AsDiagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_rgjidg_a");
  ...
  private EditorCell createDiagramConnector_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      SNodeEdgeAccessor accessor = new SNodeEdgeAccessor(node, EndpointUtil.createAccessorKeyForSNode(((SNode) _variablesContext.getValue("thisNode")))) {
        private EditorCell startRoleCell = DiagramUtil.getCellIfNotEmpty(new Inline_Builder_rgjidg_a0a0(editorContext, node).createCell());
        private EditorCell endRoleCell = DiagramUtil.getCellIfNotEmpty(new Inline_Builder_rgjidg_a0a0_0(editorContext, node).createCell());
...

        {
          ...
          if (reverse) {
            ...
            {
              Tuples._2<IConnectionEndpointReference, IConnectionEndpointReference> _tmp_bol95m_b0b0i0a0a1a2a3a9 = MultiTuple.<IConnectionEndpointReference,IConnectionEndpointReference>from(endpointTo, endpointFrom);
              endpointFrom = _tmp_bol95m_b0b0i0a0a1a2a3a9._0();
              endpointTo = _tmp_bol95m_b0b0i0a0a1a2a3a9._1();
            }
            {
              Tuples._2<EditorCell, EditorCell> _tmp_bol95m_c0b0i0a0a1a2a3a9 = MultiTuple.<EditorCell,EditorCell>from(endRoleCell, startRoleCell);
              startRoleCell = _tmp_bol95m_c0b0i0a0a1a2a3a9._0();
              endRoleCell = _tmp_bol95m_c0b0i0a0a1a2a3a9._1();
            }
            {
              Tuples._2<IShape, IShape> _tmp_bol95m_d0b0i0a0a1a2a3a9 = MultiTuple.<IShape,IShape>from(endShape, startShape);
              startShape = _tmp_bol95m_d0b0i0a0a1a2a3a9._0();
              endShape = _tmp_bol95m_d0b0i0a0a1a2a3a9._1();
            }
          }
        }
      ...
      editorCell.setCellId("DiagramConnector_rgjidg_a0");
      Style style = new StyleImpl();
      style.set(StyleAttributes.BACKGROUND_COLOR, getStyleRegistry().getSimpleColor(MPSColors.gray));
      editorCell.getStyle().putAll(style);
  ...
  /*package*/ static class Inline_Builder_rgjidg_a0a0 extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;

    /*package*/ Inline_Builder_rgjidg_a0a0(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
    ...
    private EditorCell createCollection_1() {
      ...
      editorCell.setCellId("Collection_rgjidg_a0a0a");
      Style style = new StyleImpl();
    ...
    private EditorCell createRefNode_0() {
      SingleRoleCellProvider provider = new MemberEndSourceSingleRoleHandler_rgjidg_a0a0a0(myNode, LINKS.MemberEndSource$ycMx, getEditorContext());
      return provider.createCell();
    }
    private static class MemberEndSourceSingleRoleHandler_rgjidg_a0a0a0 extends SingleRoleCellProvider {
      @NotNull
      private SNode myNode;

      public MemberEndSourceSingleRoleHandler_rgjidg_a0a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  /*package*/ static class Inline_Builder_rgjidg_a0a0_0 extends AbstractEditorBuilder {
    @NotNull
    private SNode myNode;

    /*package*/ Inline_Builder_rgjidg_a0a0_0(@NotNull EditorContext context, @NotNull SNode node) {
      super(context);
      myNode = node;
    }
    ...
    private EditorCell createCollection_2() {
      EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
      editorCell.setCellId("Collection_rgjidg_a0a0a_0");
      Style style = new StyleImpl();
      style.set(StyleAttributes.SELECTABLE, false);
      editorCell.getStyle().putAll(style);
    ...
    private EditorCell createRefNode_1() {
      SingleRoleCellProvider provider = new MemberEndTargetSingleRoleHandler_rgjidg_a0a0a0(myNode, LINKS.MemberEndTarget$yd1y, getEditorContext());
      return provider.createCell();
    }
    private static class MemberEndTargetSingleRoleHandler_rgjidg_a0a0a0 extends SingleRoleCellProvider {
      @NotNull
      private SNode myNode;

      public MemberEndTargetSingleRoleHandler_rgjidg_a0a0a0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
        super(containmentLink, context);
        myNode = ownerNode;
      }
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_rgjidg_b0");
