...
/*package*/ class Composition_AsDiagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Composition_AsDiagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_57p8zk_a");
  ...
  private EditorCell createDiagramConnector_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, () -> {
      ...
      SNodeEdgeAccessor accessor = new SNodeEdgeAccessor(node, EndpointUtil.createAccessorKeyForSNode(((SNode) _variablesContext.getValue("thisNode")))) {
        ...
        private IShape startShape = new DiamondHead(0.5, true);
...

        {
          ...
          if (reverse) {
            ...
            {
              Tuples._2<IConnectionEndpointReference, IConnectionEndpointReference> _tmp_d0qc26_b0b0i0a0a1a2a3a9 = MultiTuple.<IConnectionEndpointReference,IConnectionEndpointReference>from(endpointTo, endpointFrom);
              endpointFrom = _tmp_d0qc26_b0b0i0a0a1a2a3a9._0();
              endpointTo = _tmp_d0qc26_b0b0i0a0a1a2a3a9._1();
            }
            {
              Tuples._2<EditorCell, EditorCell> _tmp_d0qc26_c0b0i0a0a1a2a3a9 = MultiTuple.<EditorCell,EditorCell>from(endRoleCell, startRoleCell);
              startRoleCell = _tmp_d0qc26_c0b0i0a0a1a2a3a9._0();
              endRoleCell = _tmp_d0qc26_c0b0i0a0a1a2a3a9._1();
            }
            {
              Tuples._2<IShape, IShape> _tmp_d0qc26_d0b0i0a0a1a2a3a9 = MultiTuple.<IShape,IShape>from(endShape, startShape);
              startShape = _tmp_d0qc26_d0b0i0a0a1a2a3a9._0();
              endShape = _tmp_d0qc26_d0b0i0a0a1a2a3a9._1();
            }
          }
        }
      ...
      editorCell.setCellId("DiagramConnector_57p8zk_a0");
